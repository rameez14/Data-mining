...
#$ -o Q1_2_20_Cores_Output.output #This is where your output and errors are logged.
...
spark-submit --driver-memory 10g --executor-memory 5g --master local[20] Code/Q1_2.py